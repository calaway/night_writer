...
class NightWriter
  ...
  def initialize
    ...
    plaintext_to_braille_row_2 = {"$"=>".0", "#"=>"00", " "=>"..", "a"=>"..", "b"=>"..", "c"=>"..", "d"=>"..", "e"=>"..", "f"=>"..", "g"=>"..", "h"=>"..", "i"=>"..", "j"=>"..", "k"=>"0.", "l"=>"0.", "m"=>"0.", "n"=>"0.", "o"=>"0.", "p"=>"0.", "q"=>"0.", "r"=>"0.", "s"=>"0.", "t"=>"0.", "u"=>"00", "v"=>"00", "w"=>".0", "x"=>"00", "y"=>"00", "z"=>"00", "!"=>"0.", "'"=>"0.", ","=>"..", "-"=>"00", "."=>".0", "?"=>"00", "A"=>"....", "B"=>"....", "C"=>"....", "D"=>"....", "E"=>"....", "F"=>"....", "G"=>"....", "H"=>"....", "I"=>"....", "J"=>"....", "K"=>"..0.", "L"=>"..0.", "M"=>"..0.", "N"=>"..0.", "O"=>"..0.", "P"=>"..0.", "Q"=>"..0.", "R"=>"..0.", "S"=>"..0.", "T"=>"..0.", "U"=>"..00", "V"=>"..00", "W"=>"...0", "X"=>"..00", "Y"=>"..00", "Z"=>"..00", "1"=>"..", "2"=>"..", "3"=>"..", "4"=>"..", "5"=>"..", "6"=>"..", "7"=>"..", "8"=>"..", "9"=>"..", "0"=>".."}
    @braille_translation = ["", "", ""]
